...
! function(a) {
	...
	a.extend(a.fn, {
		...
		valid: function(fn) {//lgm改了这里为了出现弹出提示
			/*var b, c;
			...
			var b, c;
			var errorList = a(this[0]).is("form") ? b = this.validate().form() : (b = !0, c = a(this[0].form).validate(), this.each(function() {
					b = c.element(this) && b
				})),
				b;
			fn && (typeof fn == 'function') && fn(errorList);
		},
